...
import avatar from '../../assets/Chacha.jpg'
...
//find the posts with their matching id 
const post = postData.find(post => post.id === parseInt(id))
   
  return (
    <div className="single-post">
      <div className="content">
        <img className="single-cover" src={post.cover}/>
        <div className="user">
        ...
        <div className="comments-section">
          <h3 className="comments-heading"> Share Your Thoughts </h3>
          <input className="comment-author" type="text" placeholder="Your Name"/>
          <br/>
          <input className="comment-email" type="text" placeholder="Your Email"/>
          <br/>
